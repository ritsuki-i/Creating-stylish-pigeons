...
def stylechange(input_path, style_path):
    ...
    content_features = {layer: feature.to(device) for layer, feature in content_features.items()}
    style_grams = {layer: gram.to(device) for layer, gram in style_grams.items()}
